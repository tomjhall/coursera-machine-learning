...
for i = 1:m
	yAsVector = 1:num_labels == y(i);
	J += -yAsVector * log(A3(i,:))' - (1-yAsVector) * log(1 - A3(i,:))';
end
...
% add the regularization but not the bias 
